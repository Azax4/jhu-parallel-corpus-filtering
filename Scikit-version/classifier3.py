...
parser.add_argument("--neg_src", default="pos-1.txt", help="file with negative samples generated using source language")
parser.add_argument("--neg_tgt", default="pos-2.txt", help="file with negative samples generated using target language")
